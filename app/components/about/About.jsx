      ...
      <div>
        ...
        <div className="flex flex-col items-center w-full h-auto bg-back rounded-[93px] p-24">
          <p className="text-4xl font-medium text-center md:leading-[85px] 2xl:leading-[90px] ">
            ...
            Tehran.  My journey began six months ago when I took the
            fundamental course in HTML, CSS, and JavaScript. Recently, I
            completed my React JS course. I hold a bachelor's degree in
            ICT from Shamsipour University and have fulfilled my military
            service obligations. Currently, I have an intermediate level of
